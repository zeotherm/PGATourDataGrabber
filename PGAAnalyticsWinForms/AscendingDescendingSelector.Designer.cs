...
{
	partial class AscendingDescendingSelector
	{
		/// <summary>
		...
		private void InitializeComponent() {
			...
			this.label1.Text = "Good values high or low?";
			// 
			// radioButton2
			// 
			...
			this.Name = "AscendingDescendingSelector";
			this.Text = "AscendingDescendingSelector";
