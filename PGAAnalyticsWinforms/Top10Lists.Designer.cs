namespace PGAAnalyticsWinForms
{
	partial class Top10Lists
	{
		...
		private void InitializeComponent()
		{
			...
			this.Stat1 = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			// Player1
			// 
			this.Player1.HeaderText = "Player Name";
			this.Player1.Name = "Player1";
			this.Player1.ReadOnly = true;
			// 
			// Stat1
			// 
			this.Stat1.HeaderText = "Stat Value";
			this.Stat1.Name = "Stat1";
			this.Stat1.ReadOnly = true;
			// 
			// tabPage2
			// 
			...
			// Player2
			// 
			this.Player2.HeaderText = "Player Name";
			this.Player2.Name = "Player2";
			this.Player2.ReadOnly = true;
			// 
			// Stat2
			// 
			this.Stat2.HeaderText = "Stat Value";
			...
			// Player3
			// 
			this.Player3.HeaderText = "Player Name";
			this.Player3.Name = "Player3";
			this.Player3.ReadOnly = true;
			// 
			// Stat3
			// 
			this.Stat3.HeaderText = "Stat Value";
			...
			// Player4
			// 
			this.Player4.HeaderText = "Player Name";
			this.Player4.Name = "Player4";
			this.Player4.ReadOnly = true;
			// 
			// Stat4
			// 
			this.Stat4.HeaderText = "Stat Value";
			...
			// Player5
			// 
			this.Player5.HeaderText = "Player Name";
			this.Player5.Name = "Player5";
			this.Player5.ReadOnly = true;
			// 
			// Stat5
			// 
			this.Stat5.HeaderText = "Stat Value";
			...
			// Player6
			// 
			this.Player6.HeaderText = "Player Name";
			this.Player6.Name = "Player6";
			this.Player6.ReadOnly = true;
			// 
			// Stat6
			// 
			this.Stat6.HeaderText = "Stat Value";
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn Stat1;
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn Stat3;
		private System.Windows.Forms.DataGridView dataGridView4;
		private System.Windows.Forms.DataGridViewTextBoxColumn Player4;
		private System.Windows.Forms.DataGridViewTextBoxColumn Stat4;
		private System.Windows.Forms.DataGridView dataGridView5;
		private System.Windows.Forms.DataGridViewTextBoxColumn Player5;
		private System.Windows.Forms.DataGridViewTextBoxColumn Stat5;
